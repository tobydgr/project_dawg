...
- optional Beispielbilder korrekter und falscher Klassifikationen. [3]

Falls Poster, Screenshots oder Vergleichsgrafiken vorliegen, können sie direkt in dieses Repository eingebunden werden, um die Projektergebnisse visuell nachvollziehbar zu machen. Gerade bei Computer-Vision-Projekten sind qualitative Beispiele laut Metriken-Skript eine sinnvolle Ergänzung zu den reinen Zahlenwerten. [3]

## Poster und Slides

Zum Projekt gehören zusätzlich ein Poster und gegebenenfalls Vortragsfolien im PDF-Format. Diese Dateien sollten im Repository in einem eigenen Ordner wie `docs/` oder `presentation/` abgelegt und im README verlinkt werden. So ist das Projekt nicht nur technisch dokumentiert, sondern auch für Präsentation und Abgabe vollständig nachvollziehbar. [3]

Empfohlene Struktur:
- `docs/poster.pdf`
- `docs/slides.pdf`

Beispiel für die Verlinkung im Repository:
